...
func NewPgxStore(db *pgxpool.Pool, keyPairs ...[]byte) *PgxStore {
	store := &PgxStore{
...
func (s *PgxStore) save(session *sessions.Session) error {
...
func (s *PgxStore) load(session *sessions.Session) error {
	var encoded []byte
...
func (s *PgxStore) erase(session *sessions.Session) error {
